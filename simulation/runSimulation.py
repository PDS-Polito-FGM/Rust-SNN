...
for i in range(numberOfCycles):
	...
	spikesTrains = imgToSpikeTrain(imgArray[i], dt, computationSteps,
			inputIntensity, rng)
...
accuracies = computePerformance(i, updateInterval, countersEvolution, 
			labelsArray, assignments, accuracies)
